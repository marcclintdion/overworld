 ...
 - (void)pinchDetected:(UIPinchGestureRecognizer *)pinchRecognizer
{
        ...
        //=========================================================================================
        eye_POSITION[2] /= scale;
        
        //NSLog(@"eye_POSITION[2]: %f", eye_POSITION[2]);
...
- (void)panDetected:(UIPanGestureRecognizer *)panRecognizer
{
    ...
    eye_POSITION[0] +=  locationOnScreen.x * 0.0005;
    eye_POSITION[1] -=  locationOnScreen.y * 0.0005;
